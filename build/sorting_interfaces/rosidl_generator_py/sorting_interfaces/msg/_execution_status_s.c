...
bool sorting_interfaces__msg__execution_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("sorting_interfaces.msg._execution_status.ExecutionStatus", full_classname_dest, 56) == 0);
  }
  sorting_interfaces__msg__ExecutionStatus * ros_message = _ros_message;
  {  // object_id
...
PyObject * sorting_interfaces__msg__execution_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("sorting_interfaces.msg._execution_status");
