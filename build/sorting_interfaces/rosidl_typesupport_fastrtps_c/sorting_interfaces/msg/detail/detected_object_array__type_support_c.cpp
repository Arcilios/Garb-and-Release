...
#include "sorting_interfaces/msg/detail/detected_object_array__rosidl_typesupport_fastrtps_c.h"
...
#include "sorting_interfaces/msg/detail/detected_object__functions.h"  // objects
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions

bool cdr_serialize_sorting_interfaces__msg__DetectedObject(
  const sorting_interfaces__msg__DetectedObject * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_sorting_interfaces__msg__DetectedObject(
  eprosima::fastcdr::Cdr & cdr,
  sorting_interfaces__msg__DetectedObject * ros_message);

size_t get_serialized_size_sorting_interfaces__msg__DetectedObject(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_sorting_interfaces__msg__DetectedObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_sorting_interfaces__msg__DetectedObject(
  const sorting_interfaces__msg__DetectedObject * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_sorting_interfaces__msg__DetectedObject(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_sorting_interfaces__msg__DetectedObject(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, sorting_interfaces, msg, DetectedObject)();
...
using _DetectedObjectArray__ros_msg_type = sorting_interfaces__msg__DetectedObjectArray;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_sorting_interfaces__msg__DetectedObject(
        &array_ptr[i], cdr);
    }
  }
  ...
  sorting_interfaces__msg__DetectedObjectArray * ros_message)
{
  ...
  // Field name: objects
  {
    ...
    if (ros_message->objects.data) {
      sorting_interfaces__msg__DetectedObject__Sequence__fini(&ros_message->objects);
    }
    if (!sorting_interfaces__msg__DetectedObject__Sequence__init(&ros_message->objects, size)) {
      fprintf(stderr, "failed to create array for field 'objects'");
      return false;
    }
    auto array_ptr = ros_message->objects.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_sorting_interfaces__msg__DetectedObject(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_sorting_interfaces__msg__DetectedObject(
  ...
  size_t current_alignment)
{
  ...
  // Field name: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_sorting_interfaces__msg__DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sorting_interfaces__msg__DetectedObjectArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: objects
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_sorting_interfaces__msg__DetectedObject(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: objects
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_sorting_interfaces__msg__DetectedObject(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_sorting_interfaces__msg__DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sorting_interfaces__msg__DetectedObjectArray * ros_message = static_cast<const sorting_interfaces__msg__DetectedObjectArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sorting_interfaces__msg__DetectedObjectArray(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sorting_interfaces__msg__DetectedObjectArray * ros_message = static_cast<sorting_interfaces__msg__DetectedObjectArray *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sorting_interfaces__msg__DetectedObjectArray(cdr, ros_message);
}

static uint32_t _DetectedObjectArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sorting_interfaces__msg__DetectedObjectArray(
...
static size_t _DetectedObjectArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sorting_interfaces__msg__DetectedObjectArray(
