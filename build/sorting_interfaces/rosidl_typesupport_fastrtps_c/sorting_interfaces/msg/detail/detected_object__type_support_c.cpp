...
#include "sorting_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // class_name, object_id
#include "rosidl_runtime_c/string_functions.h"  // class_name, object_id
...
using _DetectedObject__ros_msg_type = sorting_interfaces__msg__DetectedObject;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sorting_interfaces__msg__DetectedObject;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const sorting_interfaces__msg__DetectedObject * ros_message = static_cast<const sorting_interfaces__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_sorting_interfaces__msg__DetectedObject(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  sorting_interfaces__msg__DetectedObject * ros_message = static_cast<sorting_interfaces__msg__DetectedObject *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_sorting_interfaces__msg__DetectedObject(cdr, ros_message);
}

static uint32_t _DetectedObject__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_sorting_interfaces__msg__DetectedObject(
...
static size_t _DetectedObject__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_sorting_interfaces__msg__DetectedObject(
