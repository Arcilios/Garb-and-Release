...
static const _ExecutionStatus_type_support_symbol_names_t _ExecutionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sorting_interfaces, msg, ExecutionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sorting_interfaces, msg, ExecutionStatus)),
  }
};
...
{
  return &::sorting_interfaces::msg::rosidl_typesupport_cpp::ExecutionStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sorting_interfaces, msg, ExecutionStatus)() {
  return get_message_type_support_handle<sorting_interfaces::msg::ExecutionStatus>();
}
