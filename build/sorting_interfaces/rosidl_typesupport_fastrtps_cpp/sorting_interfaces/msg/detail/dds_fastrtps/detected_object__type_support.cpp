...
#include "sorting_interfaces/msg/detail/detected_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const sorting_interfaces::msg::DetectedObject & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  sorting_interfaces::msg::DetectedObject & ros_message)
{
  // Member: object_id
  cdr >> ros_message.object_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = sorting_interfaces::msg::DetectedObject;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const sorting_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sorting_interfaces::msg::DetectedObject *>(
    untyped_ros_message);
...
{
  return &sorting_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sorting_interfaces, msg, DetectedObject)() {
  return &sorting_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObject__handle;
}
