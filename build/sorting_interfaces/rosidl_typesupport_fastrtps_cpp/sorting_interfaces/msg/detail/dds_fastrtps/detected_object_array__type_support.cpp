...
#include "sorting_interfaces/msg/detail/detected_object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const sorting_interfaces::msg::DetectedObject &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  sorting_interfaces::msg::DetectedObject &);
size_t get_serialized_size(
  const sorting_interfaces::msg::DetectedObject &,
  size_t current_alignment);
size_t
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      sorting_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  sorting_interfaces::msg::DetectedObjectArray & ros_message)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      sorting_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sorting_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sorting_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = sorting_interfaces::msg::DetectedObjectArray;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: objects
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      sorting_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.objects[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        sorting_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.objects[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        sorting_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const sorting_interfaces::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<sorting_interfaces::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  return &sorting_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObjectArray__handle;
}
